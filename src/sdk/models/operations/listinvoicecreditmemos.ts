...
export class ListInvoiceCreditMemosRequest extends SpeakeasyBase {
    /**
...
export class ListInvoiceCreditMemosResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;

    @SpeakeasyMetadata()
    listInvoiceCreditMemoResponse?: shared.ListInvoiceCreditMemoResponse;
