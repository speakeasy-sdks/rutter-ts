...
export class ListExpensesRequest extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=expense_type" })
...
export class ListExpensesResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;

    @SpeakeasyMetadata()
    listExpenseResponseWithConnection?: shared.ListExpenseResponseWithConnection;
