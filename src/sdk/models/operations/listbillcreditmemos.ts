...
export class ListBillCreditMemosRequest extends SpeakeasyBase {
    /**
...
export class ListBillCreditMemosResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;

    @SpeakeasyMetadata()
    listBillCreditMemoResponseWithConnection?: shared.ListBillCreditMemoResponseWithConnection;
