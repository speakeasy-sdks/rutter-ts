...
export class ListSubsidiariesRequest extends SpeakeasyBase {
    /**
...
export class ListSubsidiariesResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;

    @SpeakeasyMetadata()
    listSubsidiaryResponseWithConnection?: shared.ListSubsidiaryResponseWithConnection;
