...
export class ListInvoicePaymentsRequest extends SpeakeasyBase {
    /**
...
export class ListInvoicePaymentsResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;

    @SpeakeasyMetadata()
    listInvoicePaymentResponse?: shared.ListInvoicePaymentResponse;
