...
export class InvoiceCreditMemoLineItems extends SpeakeasyBase {
    /**
...
export class InvoiceCreditMemoLinkedInvoices extends SpeakeasyBase {
    @SpeakeasyMetadata()
 ...
 */
export enum InvoiceCreditMemoStatus {
    Open = "OPEN",
    Applied = "APPLIED",
...
export class InvoiceCreditMemo extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata({ elemType: InvoiceCreditMemoLineItems })
    @Expose({ name: "line_items" })
    @Type(() => InvoiceCreditMemoLineItems)
    lineItems: InvoiceCreditMemoLineItems[];

    /**
     * An array of Rutter IDs of [Invoices](/rest/version/invoices) linked to the invoice credit memo.
     */
    @SpeakeasyMetadata({ elemType: InvoiceCreditMemoLinkedInvoices })
    @Expose({ name: "linked_invoices" })
    @Type(() => InvoiceCreditMemoLinkedInvoices)
    linkedInvoices: InvoiceCreditMemoLinkedInvoices[];
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "status" })
    status: InvoiceCreditMemoStatus;
